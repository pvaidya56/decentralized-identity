      ...
      <Head>
        ...
        <div style={{ paddingTop: 50, width: 500, margin: '0 auto', display: 'flex', flex: 1 }}>
          <div className="flex flex-1 flex-col justify-center">
            ...
            <p className="text-xl text-center mt-2 text-gray-400">Authentication flow:</p>
...

          {
            !loaded && (
              ...
              <button
              onClick={connect}
              className="pt-4 shadow-md bg-blue-800 mt-4 mb-2 text-white font-bold py-2 px-4 rounded"
            >Authenticate</button>
            
            <button className="pt-4 shadow-md bg-yellow-500 mb-2 text-white font-bold py-2 px-4 rounded" onClick={readProfile}>Read Profile</button>
            </>
            )
          }
          {
